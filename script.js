...
window.pickRandomWebtoon = function() {
  ...
  const resultDiv = document.getElementById('random-result'); resultDiv.innerHTML = `<span style="font-size:16px;">오늘의 정주행 픽은..</span><br>✨ <span style="color:#111;">${pickedWork.name}</span> ✨`;
}
